# Migration Guide: Legacy → v1.0.0

**Tracklay v1.0.0 removes ALL legacy detectable routes for maximum anti-tracking protection.**
...
**Note:** v1.0.0 implements ultra-aggressive obfuscation:
...
**AFTER (v1.0.0 - Ultra-Aggressive, Undetectable):**
...
🔵 FACEBOOK PIXEL (Meta Pixel)
   ...
   Ultra-Obfuscated Path (v1.0.0 - no suffix):
...
### Step 3: Deploy Tracklay v1.0.0

**ONLY after your theme is updated**, deploy v1.0.0:
...
### UUID Rotation (Automatic - v1.0.0 Feature)

**v1.0.0 includes AUTOMATIC UUID rotation** for maximum security:
...
<!-- Facebook Pixel Code (v1.0.0 - NO SUFFIX) -->
<script>
  !function(f,b,e,v,n,t,s)
  {if(f.fbq)return;n=f.fbq=function(){n.callMethod?
  n.callMethod.apply(n,arguments):n.queue.push(arguments)};
...
<!-- Google Tag Manager (v1.0.0 - NO SUFFIX) -->
<script>
...
<!-- Google Analytics 4 (v1.0.0 - NO SUFFIX) -->
...
- v1.0.0 should have ~10-20% detection rate (down from 90-100%)
...
**⚠️ NOT RECOMMENDED** - Defeats the security purpose of v1.0.0
