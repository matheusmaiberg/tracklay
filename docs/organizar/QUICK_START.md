...
>
> **v1.0.0 removed ALL legacy routes** mentioned in this document (e.g., `/cdn/gtag/js`, `/cdn/gtm.js`).
>
> **For v1.0.0+ setup**, please see:
...
> - **Main README**: [README.md](../README.md) - v1.0.0 features and examples
>
> **Key v1.0.0 Changes:**
