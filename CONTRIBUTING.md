...
| `core/`       | Core utilities              | `logger.js`, `uuid.js`, `cache.js`   |
| `headers/`    | Header construction         | `cors.js`, `security.js`, `proxy.js` |
| `handlers/`   | Request handling            | `scripts.js`, `endpoints.js`         |
| `proxy/`      | Proxy logic                 | `index.js`, `cache-strategy.js`      |
| `routing/`    | URL routing                 | `router.js`, `mapping.js`            |
| `middleware/` | Request/response middleware | `validator.js`, `error-handler.js`   |
| `utils/`      | Shared utilities            | `response.js`, `constants.js`        |
