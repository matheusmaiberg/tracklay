...
### v3.0.0 - Ultra-Aggressive Obfuscation

#### ⚠️ BREAKING CHANGES

**This release removes ALL legacy detectable routes for maximum anti-tracking protection.**

If upgrading from earlier implementations, you **MUST** update your Shopify theme before deploying.
...
4. Deploy worker **AFTER** theme updates

**Compatibility:**
- ❌ No backward compatibility with legacy routes
...
### v3.3.0 - Environment Variable Renaming
...
[Unreleased]: https://github.com/your-github-username/tracklay/compare/v1.0.0...HEAD
